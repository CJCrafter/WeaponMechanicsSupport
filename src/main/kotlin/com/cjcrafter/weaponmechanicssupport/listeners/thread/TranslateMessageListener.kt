...
class TranslateMessageListener(
    ...
    companion object {
        ...
        fun translateMessage(openai: OpenAI, message: String): String? {
            ...
            val request = ChatRequest("gpt-3.5-turbo", mutableListOf(
                "If the phrase given is not in English, translate it into English. Otherwise, reply \"already english\".".toSystemMessage(),
                message.take(1000).toUserMessage(),
            ), topP = 0.25f, temperature = 0.8f)
